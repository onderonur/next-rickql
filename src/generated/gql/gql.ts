...
type Documents = {
    ...
    "\n  query EpisodeDetail_Query($id: ID!) {\n    episode(id: $id) {\n      id\n      name\n      episode\n      air_date\n      characters {\n        id\n        ...CharacterCard_CharacterFragment\n      }\n    }\n  }\n": typeof types.EpisodeDetail_QueryDocument,
    ...
    "\n  query LocationDetail_Query($id: ID!) {\n    location(id: $id) {\n      id\n      name\n      type\n      dimension\n      residents {\n        id\n        ...CharacterCard_CharacterFragment\n      }\n    }\n  }\n": typeof types.LocationDetail_QueryDocument,
};
